...
class TETK_Theme_Demo_Newsportal_Magazine extends TETK_Theme_Demo
{
    ...
    public static function import_files()
    {
        ...
        $demo_urls = array(
            array(
                'import_file_name' => 'Newsportal Magazine Default',
                'import_file_url' => $server_url . 'wp-content/themes/newsportal-magazine/demo-content/content.xml',
                'import_widget_file_url' => $server_url . 'wp-content/themes/newsportal-magazine/demo-content/widgets.wie',
                'import_customizer_file_url' => $server_url . 'wp-content/themes/newsportal-magazine/demo-content/customizer.dat',
                'import_preview_image_url' => $server_url . 'wp-content/themes/newsportal-magazine/screenshot.png',
                'demo_url' => 'https://demo.themeegg.com/?name=Newsportal Magazine',
    ...
    public static function after_import($selected_import)
    {
        ...
        $feature_slider_category = get_category_by_slug('fashion');
        ...
        $term_id = isset($feature_slider_category->term_id) ? $feature_slider_category->term_id : 8;
