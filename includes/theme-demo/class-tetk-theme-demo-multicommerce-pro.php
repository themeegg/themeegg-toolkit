...
class TETK_Theme_Demo_Multicommerce_Pro extends TETK_Theme_Demo
{

    public static function import_files()
    {
        $server_url = 'https://demo.themeegg.com/themes/multicommerce-pro';
        $demo_urls = array(
            array(
                'import_file_name' => 'Multicommerce Pro Default',
...
// Assign front page and posts page (blog page).
        ...
        switch ($import_file_name) {
            ...
            case 'Multicommerce Pro Default':
