 ...
 * Needed to extend the TETK_Importer_WXR_Importer class to get/set the importer protected variables,
 * for use in the multiple AJAX calls.
 *
 * @package tetk
 */

class TETK_WXR_Importer extends TETK_Importer_WXR_Importer {
	...
	/**
	 * Get all protected variables from the TETK_Importer_WXR_Importer needed for continuing the import.
	 */
	...
	/**
	 * Sets all protected variables from the TETK_Importer_WXR_Importer needed for continuing the import.
	 *
